...
if (!function_exists('yourtheme_fonts_url')) {
    ...
    {
        $fonts_url = '';
        $content_font = get_theme_mod('fonts__headings', '');
    ...
    class Google_Font_Dropdown_Custom_Control extends WP_Customize_Control
    {
        ...
        public function get_google_fonts()
        {
            if (get_transient('mytheme_google_font_list')) {
                ...
                $googleApi = 'https://www.googleapis.com/webfonts/v1/webfonts?sort=alpha&key=AIzaSyCfDxwoigWRerVQMojFfT6nk0MMOYsz8XA';
