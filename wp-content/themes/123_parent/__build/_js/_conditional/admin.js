...
var Admin = {};
Admin.SiteSetup = {
  sections: (0, _jquery.default)('#acf-group_sitesetup_intro, #acf-group_sitesetup_1, #acf-group_sitesetup_2, #acf-group_sitesetup_3, #acf-group_sitesetup_4'),
  activeSectionIndex: undefined,
  pagination: (0, _jquery.default)('#setup-pagination'),
  nextprev: (0, _jquery.default)('#setup-nextprev span'),
  nextPrevGroup: (0, _jquery.default)('#acf-group_sitesetup_5'),
  ...
  _trackSectionIndex: function _trackSectionIndex() {
    Admin.SiteSetup.sections.each(function (index, el) {
      if (!(0, _jquery.default)(el).hasClass('setup-section--hidden')) {
  ...
  _clickedNavhandler: function _clickedNavhandler(e) {
    ...
    (0, _jquery.default)(this).addClass('active'); // determine

    var index = (0, _jquery.default)(this).index();
    Admin.SiteSetup.sections.addClass('setup-section--hidden');
    (0, _jquery.default)(Admin.SiteSetup.sections[index]).removeClass('setup-section--hidden');
