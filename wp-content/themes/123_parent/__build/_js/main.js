...
Theme.Max_Width = {
  ...
  nav: (0, _jquery["default"])("header[id^='opt_header_']"),
  _init: function _init() {
    Theme.Max_Width._set_max_width();

    (0, _jquery["default"])(window).on("resize", Theme.Max_Width._set_max_width);
  },
  _set_max_width: function _set_max_width() {
    var nav_id = Theme.Max_Width.nav.attr("id"); // 1, 2, 5, 6, 7, 8, 10

    if (nav_id == "opt_header_one" || nav_id == "opt_header_two" || nav_id == "opt_header_five" || nav_id == "opt_header_six" || nav_id == "opt_header_seven" || nav_id == "opt_header_eight" || nav_id == "opt_header_ten") {
      ...
      Theme.Max_Width._check_inner_width(nav_width); // 9

    } else if (nav_id == "opt_header_nine") {
      var nav_inner_div = (0, _jquery["default"])("header#opt_header_nine .inner_div");
      Theme.Max_Width.gallery.css("max-width", nav_inner_div.css("max-width"));
      var nav_width = (0, _jquery["default"])("header#opt_header_nine .inner_div").css("max-width");

      Theme.Max_Width._check_inner_width(nav_width); // 4
      ...
      Theme.Max_Width._check_inner_width(nav_width); // 3
  ...
  _check_inner_width: function _check_inner_width(nav_width) {
  ...
  _divide_4: function _divide_4(nav_width) {
    var divided4 = nav_width.substring(0, nav_width.indexOf('p')) / 4 - 10;
    (0, _jquery["default"])(".gallery_image").css({
      "height": divided4 + 'px',
      "width": divided4 + 'px'
    });
  },
  _divide_3: function _divide_3() {
    var mobile_width = (0, _jquery["default"])("header.mobileheader").css("width");
  ...
  _divide_2: function _divide_2() {
    var mobile_width = (0, _jquery["default"])("header.mobileheader").css("width");

    if ((0, _jquery["default"])("#gallery").hasClass("tab_sidebar") && window.innerWidth >= 550 && window.innerWidth <= 600) {
      var divided2 = mobile_width.substring(0, mobile_width.indexOf('p')) / 2 - 95;
      (0, _jquery["default"])(".gallery_image").css({
        "height": divided2 + 'px',
        "width": divided2 + 'px'
      });
    } else if ((0, _jquery["default"])("#gallery").hasClass("tab_sidebar") && window.innerWidth > 600) {
...
Theme.Popups = {
  popups: (0, _jquery["default"])(".popup"),
  quote_btn: (0, _jquery["default"])(".site__button-quote"),
  header_popup: (0, _jquery["default"])("#header_popup"),
  timed_popup: (0, _jquery["default"])("#timed_overlay_popup"),
  header_popup_times: (0, _jquery["default"])("#header_popup .popup_close"),
  timed_popup_times: (0, _jquery["default"])("#timed_overlay_popup .popup_close"),
  ...
  _header_popup_section_close: function _header_popup_section_close(event) {
    if (event.target == event.currentTarget) Theme.Popups.header_popup.fadeOut(250);
  },
  _timed_popup_close: function _timed_popup_close() {
    Theme.Popups.timed_popup.fadeOut(250);

    Theme.Popups._increase_timed_views();
  },
  _timed_popup_section_close: function _timed_popup_section_close(event) {
    if (event.target == event.currentTarget) Theme.Popups.timed_popup.fadeOut(250, function () {
      Theme.Popups._increase_timed_views();
    });
  },
  _resize_close: function _resize_close() {
    Theme.Popups.popups.hide();

    Theme.Popups._increase_timed_views();
  },
  _increase_timed_views: function _increase_timed_views() {
    var views = (0, _jquery["default"])("#timed_overlay_popup").attr("data-viewed");
    views++;
    (0, _jquery["default"])("#timed_overlay_popup").attr("data-viewed", views);

    Theme.Popups._start_timed_popup_second();
  },
  _start_timed_popup: function _start_timed_popup() {
    setTimeout(function () {
      Theme.Popups.timed_popup.fadeIn(100);
    }, Theme.Popups.timed_first_view * 1000);
  },
  _start_timed_popup_second: function _start_timed_popup_second() {
    var views = (0, _jquery["default"])("#timed_overlay_popup").attr("data-viewed");
...
Hero.Padding_Top = {
  ...
  _header_function: function _header_function() {
    ...
    if (Hero.Padding_Top.header_position === "fixed" && Hero.Padding_Top.header_id !== "opt_header_one" && Hero.Padding_Top.header_id !== "opt_header_four" && Hero.Padding_Top.header_id !== "opt_header_nine" && Hero.Padding_Top.header_id !== "opt_header_three" && Hero.Padding_Top.header_id !== "opt_header_eight") {
    ...
    } else if (Hero.Padding_Top.header_id === "opt_header_four") {
      Hero.Padding_Top.height = (0, _jquery["default"])("header#" + Hero.Padding_Top.header_id + ">div:last-of-type").height();
      Hero.Padding_Top.main.css("padding-top", Hero.Padding_Top.height);
    } else if (Hero.Padding_Top.header_id === "opt_header_nine") {
      Hero.Padding_Top.height = (0, _jquery["default"])("header#" + Hero.Padding_Top.header_id + ">div:first-of-type").height();
      Hero.Padding_Top.main.css("padding-top", Hero.Padding_Top.height);
    } else {
