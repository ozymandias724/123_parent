...
Hero = {
  ...
  Padding: {
    header_id: (0, _jquery.default)("header").attr("id"),
    header_height: (0, _jquery.default)("header").height(),
    mobile_header_height: (0, _jquery.default)(".mobileheader").height(),
    main: (0, _jquery.default)(".mobileheader").next(),
    _init: function _init() {
    ...
    _header_function: function _header_function() {
      //Get header position value
      Hero.Padding.header_position = (0, _jquery.default)("header").css("position"); //If header has a position of fixed and not header 4

      if (Hero.Padding.header_position === "fixed" && Hero.Padding.header_id !== "opt_header_four" && Hero.Padding.header_id !== "opt_header_nine") {
        Hero.Padding.header_height = (0, _jquery.default)("header").height();
        Hero.Padding.main.css("padding-top", Hero.Padding.header_height); //If header has a position of fixed and is header 4
      } else if (Hero.Padding.header_position === "fixed" && Hero.Padding.header_id === "opt_header_four" || Hero.Padding.header_id === "opt_header_nine") {
        Hero.Padding.header_first_div_height = (0, _jquery.default)("header#" + Hero.Padding.header_id + " > div").height();
    ...
    _mobile_header_function: function _mobile_header_function() {
      Hero.Padding.mobiler_header_height = (0, _jquery.default)(".mobileheader").height();
      Hero.Padding.main.css("padding-top", Hero.Padding.mobile_header_height);
    }
  },
  Slider: {
    slick_slider: (0, _jquery.default)("#slick-images"),
    rand: Math.floor(Math.random() * (0, _jquery.default)(".img-slick").length),
    slick_pause: (0, _jquery.default)("#slick-pause"),
    slick_play: (0, _jquery.default)("#slick-play"),
    _init: function _init() {
    ...
    _start_slider: function _start_slider() {
      (0, _jquery.default)("#slick-images").slick({
...
Theme.Headers = {
  tint: (0, _jquery.default)(".header-tint"),
  estimate: (0, _jquery.default)(".estimate-toggle, .topbanner-quickquote, .site__button-quote"),
  estimate_popup: (0, _jquery.default)(".estimate"),
  estimate_close: (0, _jquery.default)(".estimate.popupcontainer, .estimate-content-times.popupcontainer-times"),
  _init: function _init() {
    (0, _jquery.default)(Headers.Mobile.estimate).on("click", Theme.Headers._click_handler);
    (0, _jquery.default)(Headers.Mobile.estimate_close).on("click", Theme.Headers._close_popup);
  },
  _click_handler: function _click_handler(event) {
    event.preventDefault();
    Theme.Headers.estimate_popup.fadeIn(250);
  },
  _close_popup: function _close_popup(event) {
    if ((0, _jquery.default)(event.target).hasClass("estimate") || (0, _jquery.default)(event.target).hasClass("estimate-content-times") || (0, _jquery.default)(event.target).hasClass("topbanner-quickquote") || (0, _jquery.default)(event.target).hasClass("site__button-quote")) {
      event.preventDefault();
...
Theme.PA = {
  container: (0, _jquery.default)('.pa.popupcontainer'),
  submit: (0, _jquery.default)('.pa.popupcontainer input[type="submit"]'),
  _init: function _init() {
  ...
  _clickHandler: function _clickHandler(e) {
    if ((0, _jquery.default)(e.target).hasClass('pa') || (0, _jquery.default)(e.target).hasClass('popupcontainer-times')) {
      if ((0, _jquery.default)(e.target).has('.ginput_container').length == 0) {
  ...
  _showPA: function _showPA() {
    if (Theme.PA.container.length > 0 && (0, _jquery.default)(window).width() >= 1025) {
