...
(0, _jquery["default"])(document).ready(function () {
  // idk
  // if header six
  if ((0, _jquery["default"])('header#opt_header_six').length) {
    var offset = (0, _jquery["default"])('header#opt_header_six').height();
  ...
  if ((0, _jquery["default"])('#popups__timed_overlay').length) {
    PopUps.Timed = {
      ...
      _init: function _init() {
        (0, _jquery["default"])(window).on('load', PopUps.Timed._setInitial);
      },
