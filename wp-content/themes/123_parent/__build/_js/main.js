...
var Hero = {};
var Headers = {};
var rand = Math.floor(Math.random() * (0, _jquery.default)(".img-slick").length);
...
Hero = {
  ...
  Padding: {
    ...
    _header_function: function _header_function() {
      ...
      Hero.Padding.header_position = (0, _jquery.default)("header").css("position"); //If header has a position of fixed and not header 1, 4, 9 or 3
      ...
      } else if (Hero.Padding.header_position === "fixed" && Hero.Padding.header_id === "opt_header_one" || Hero.Padding.header_id === "opt_header_four" || Hero.Padding.header_id === "opt_header_nine") {
