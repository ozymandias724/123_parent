...
(0, _jquery["default"])(document).ready(function () {
  ...
  if ((0, _jquery["default"])('header').length) {
    ...
    if ((0, _jquery["default"])('header.header').css('position') == 'fixed' && headers.includes(headerID)) {
      ...
      if (headersDiv.includes(headerID)) {
        offset = (0, _jquery["default"])('header > div').height() + (0, _jquery["default"])('#popups__banner').height();
      } else {
        offset = (0, _jquery["default"])('header').height() + (0, _jquery["default"])('#popups__banner').height();
      }
  ...
  if ((0, _jquery["default"])('section.block__galleries').length && (0, _jquery["default"])('section.block__galleries div.tabs').length) {
    ...
    Blocks.Gallery = {
      tabs: (0, _jquery["default"])('.block__galleries div.tabs > ul > li'),
  ...
  */
  ...
  if ((0, _jquery["default"])('section.block__food_menus').length && (0, _jquery["default"])('section.block__food_menus div.tabs').length) {
    Blocks.FoodMenus = {
      tabs: (0, _jquery["default"])('.block__food_menus div.tabs > ul > li'),
      food_menus: (0, _jquery["default"])('.block__food_menus div.tabs > .menu_area > ul.menu_section'),
      _init: function _init() {
