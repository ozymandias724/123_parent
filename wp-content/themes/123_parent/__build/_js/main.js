...
Theme.Menu = {
  tab_header: (0, _jquery["default"])("#mod_menu #menu_tabs > h5"),
  tab_link: (0, _jquery["default"])("#mod_menu #menu_tabs > h5 > a"),
...
Headers.One._init(); // NOPE. no reason to add window resize just for this. well find another way
// Hero.Padding_Top = {
